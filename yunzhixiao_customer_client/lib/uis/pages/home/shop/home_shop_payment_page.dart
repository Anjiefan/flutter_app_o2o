...
class HomeShopPaymentPage extends StatefulWidget {
  final ShopPaymentParam param;

  const HomeShopPaymentPage({Key key, this.param}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _HomeShopPaymentPageState();
}

class _HomeShopPaymentPageState extends State<HomeShopPaymentPage>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      model: ShopPaymentModel(widget.param.shopId, context),
      onModelReady: (model) {
...
//                                  )
  ...
  void _showDialog(BuildContext cxt, ShopPaymentModel model) {
...
class ShopPaymentParam {
  final String shopName;
  final int shopId;

  ShopPaymentParam(this.shopName, this.shopId);
}
