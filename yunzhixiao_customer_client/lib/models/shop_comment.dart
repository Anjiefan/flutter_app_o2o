...
class CommodityCommentList {
  List<CommodityCommentItem> data;

  CommodityCommentList({this.data});

  CommodityCommentList.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = new List<CommodityCommentItem>();
      json['data'].forEach((v) {
        data.add(new CommodityCommentItem.fromJson(v));
      });
    }
  }
...
class CommodityCommentItem {
  ...
  CommodityCommentItem.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    userInfo = json['user_info'] != null
        ? new UserInfo.fromJson(json['user_info'])
        : null;
