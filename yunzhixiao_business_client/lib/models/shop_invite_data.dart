class ShopInviteData {
  ...
  ShopInviteData.fromJson(Map<String, dynamic> json) {
    ...
    mounthNum = json['month_num'];
    mounthInvitesDivideThis = json['month_invites_divide_this'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['month_num'] = this.mounthNum;
    data['month_invites_divide_this'] = this.mounthInvitesDivideThis;
